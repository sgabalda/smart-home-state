...
class InputTopicsManagerSuite extends CatsEffectSuite {
  ...
  test("on batteries temperature topic it should properly decode the temperature") {
    val conversions = InputTopicsManager.apply.inputTopicsConversions

    conversions("diposit1/temperature/batteries")(Vector[Byte](49, 54, 46, 57, 52)) match {
