...
object CarChargerTestHelper {
  ...
  def stateWithCarCharger(
      ...
      automaticOnSince: Option[Instant] = None,
    ...
    State()
      ...
      .setTo(
        State.CarCharger(
          ...
          automaticOnSince = automaticOnSince,
          currentPowerWatts = currentPowerWatts,
          plannedDynamicFVPower = plannedDynamicFVPower,
          plannedDynamicGridPower = plannedDynamicGridPower,
